...
var ClusterDAO = /** @class */ (function () {
    function ClusterDAO() {
    }
    ClusterDAO.prototype.getAllMachines = function (req, res, next) {
        var clientOptions = {};
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, client.GetAllMachines()];
                        case 2:
                            _a = _b.sent(), result = _a.result, envelope = _a.envelope, soapHeader = _a.soapHeader;
                            traversalObj = fast_xml_parser_1.default.getTraversalObj(result.ClusterServer, parser_option_1.ParserOption);
                            jsonData = fast_xml_parser_1.default.convertToJson(traversalObj, parser_option_1.ParserOption);
                            jsonResult = lodash_humps_1.default(jsonData.ClusterServer);
                            res.json(jsonResult);
                            return [3 /*break*/, 4];
                        case 3:
                            err_1 = _b.sent();
    ...
    ClusterDAO.prototype.getMachine = function (req, res, next) {
        var args = {
            GetMachineRequest: {
                Id: req.body.id
            }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, client.GetMachine(args)];
                        case 2:
                            _a = _b.sent(), result = _a.result, envelope = _a.envelope, soapHeader = _a.soapHeader;
                            traversalObj = fast_xml_parser_1.default.getTraversalObj(result.ClusterMachine, parser_option_1.ParserOption);
                            jsonData = fast_xml_parser_1.default.convertToJson(traversalObj, parser_option_1.ParserOption);
    ...
    ClusterDAO.prototype.saveMachine = function (req, res, next) {
        var args = {
        ...
        strong_soap_1.soap.createClient(deployment_service_settings_1.DeploymentServiceSettings.end_point_URL, clientOptions, function (err, client) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, result, envelope, soapHeader, err_3;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (err) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, client.SaveMachine(args)];
                        case 2:
                            _a = _b.sent(), result = _a.result, envelope = _a.envelope, soapHeader = _a.soapHeader;
                            res.json(result);
                            return [3 /*break*/, 4];
    ...
    ClusterDAO.prototype.deleteMachine = function (req, res, next) {
        var args = {
            SaveMachineContractRequest: {
                ClusterMachine: req.body.id
            }
        ...
        strong_soap_1.soap.createClient(deployment_service_settings_1.DeploymentServiceSettings.end_point_URL, clientOptions, function (err, client) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, result, envelope, soapHeader, err_4;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (err) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, client.DeleteMachine(args)];
                        case 2:
                            _a = _b.sent(), result = _a.result, envelope = _a.envelope, soapHeader = _a.soapHeader;
                            res.json(result);
                            return [3 /*break*/, 4];
...
exports.ClusterDAO = ClusterDAO;
//# sourceMappingURL=cluster.dao.js.map