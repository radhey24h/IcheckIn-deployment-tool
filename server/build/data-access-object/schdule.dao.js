...
var SchduleDAO = /** @class */ (function () {
    function SchduleDAO() {
    }
    SchduleDAO.prototype.getAllConfiguration = function (req, res, next) {
        var clientOptions = {};
        strong_soap_1.soap.createClient(deployment_service_settings_1.DeploymentServiceSettings.end_point_URL, clientOptions, function (err, client) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, result, envelope, soapHeader, results, jsonData, _i, results_1, resultsKey, traversalObj, jsonResponse, scheduleResponse, err_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, client.GetAllConfiguration()];
                        case 2:
                            _a = _b.sent(), result = _a.result, envelope = _a.envelope, soapHeader = _a.soapHeader;
                            results = result.Configurations.string.toString().split(',');
                            jsonData = [];
                            for (_i = 0, results_1 = results; _i < results_1.length; _i++) {
                                resultsKey = results_1[_i];
                                traversalObj = fast_xml_parser_1.default.getTraversalObj(resultsKey, parser_option_1.ParserOption);
                                jsonResponse = fast_xml_parser_1.default.convertToJson(traversalObj, parser_option_1.ParserOption).ServiceConfiguration;
                                scheduleResponse = {
    ...
    SchduleDAO.prototype.getDeployScheduleById = function (req, res, next) {
        var clientOptions = {};
        strong_soap_1.soap.createClient(deployment_service_settings_1.DeploymentServiceSettings.end_point_URL, clientOptions, function (err, client) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, result, envelope, soapHeader, err_2;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (err) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, client.GetDeployScheduleById()];
                        case 2:
                            _a = _b.sent(), result = _a.result, envelope = _a.envelope, soapHeader = _a.soapHeader;
                            res.json(result);
                            return [3 /*break*/, 4];
...
exports.SchduleDAO = SchduleDAO;
//# sourceMappingURL=schdule.dao.js.map